...
description = """
flask_example API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://flask_example.com/terms/",
    contact={
        "name": "nuynehc",
        "url": "http://flask_example.com/contact/",
        "email": "nuynehc@flask_example.com",
    },
    license_info={
        "name": "The Unlicense",
