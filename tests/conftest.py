...
# WARNING: Ensure imports from `flask_example` comes after this line
from flask_example import app, settings, db  # noqa
from flask_example.cli import create_user, cli  # noqa
